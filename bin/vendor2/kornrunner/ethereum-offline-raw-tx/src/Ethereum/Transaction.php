...
//print_r($mas);die;
        $this->nonce = $mas[nonce];
        $this->gasPrice = $mas[gasPrice];
//        $this->gasPrice = $mas[gas];
//        $this->gasLimit = $mas[gasLimit];
        $this->gasLimit = $mas[gas];
        $this->to = $mas[to];
        $this->value = $mas[value];
        $this->data = $mas[data];
    }
    ...
    public function getRaw(string $privateKey, int $chainId = 0): string {
        ...
        $a = $this->sign($privateKey, $chainId);
//print "========================\n";
//	print_r($this);
